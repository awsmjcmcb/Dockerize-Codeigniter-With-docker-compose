<?php 
	...
	//Get all Category 
	$qry="SELECT * FROM tbl_city order by id desc";
	$result=mysqli_query($mysqli,$qry);

	if(isset($_GET['delete_id']))
	{
		Delete('tbl_city','id='.$_GET['delete_id'].'');
		$_SESSION['msg']="12";
            ...
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>                  
                  ...
                  <th>City Name</th>
                  <th style="width:18%;">Delivery Charges</th>
              ...
              <tbody>
              	<?php	
					...
					<tr>                 
					  ...
					  <td><a href="add_city.php?edit_id=<?php echo $row['id'];?>" class="btn btn-primary">Edit</a>
