<?php include("includes/header.php");
	...
	//Get all Category 
	$qry="SELECT * FROM tbl_home_banner where hotelid='".$_SESSION['id']."'";
	$result=mysqli_query($mysqli,$qry);
	
	if(isset($_GET['banner_id']))
	{
 
		$cat_res=mysqli_query($mysqli,'SELECT * FROM tbl_home_banner WHERE hotelid=\''.$_SESSION['id'].'\'');
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>                 
                  ...
                  <td><span class="category_img"><img src="images/<?php echo $row['banner_image'];?>" /></span></td>
